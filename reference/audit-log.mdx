...
This page defines the file layout, record schema, scope, retention, and redaction limits. To read the log in a UI, see [Dashboard](/guides/dashboard). To read it in the terminal, see [`logs`](/reference/cli-commands#logs).
