...
description: "Definitions for the terms used across CC Safety Net documentation: fail-closed, segments, shell wrappers, interpreter one-liners, worktree relaxation, paranoid and strict modes, and more."
---
