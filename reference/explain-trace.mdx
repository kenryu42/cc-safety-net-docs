...
description: "Schema for the JSON object returned by cc-safety-net explain --json: the ExplainResult fields and the TraceStep variant types that describe each analysis step."
---
