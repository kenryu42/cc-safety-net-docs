...
A bare local name or a canonical `owner/repo#ref/<rulebook-name>` source drops the first three lines and closes with `Added rulebook source: <source>` where a repository add says `Rule config updated.`
