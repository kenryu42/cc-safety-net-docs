...
For per-agent steps, post-install actions, and legacy plugin-identifier migration, see [Installation](/installation).
...
`gui` starts the local policy editor and opens it in your browser. For dashboard views and confirmation behavior, see [Dashboard](/guides/dashboard).
