  ...
  <section className="cc-overview-section">
    ...
    <div className="cc-cli-panel">
      <div className="cc-cli-grid">
        <a className="cc-cli-card" href="/installation#claude-code">
        ...
        <a className="cc-cli-card" href="/installation#codex">
          <div className="cc-cli-icon">
        ...
        <a className="cc-cli-card" href="/installation#copilot-cli">
          <div className="cc-cli-icon">
        ...
        <a className="cc-cli-card" href="/installation#opencode">
          <div className="cc-cli-icon">
        ...
        <a className="cc-cli-card" href="/installation#kimi-code">
          <div className="cc-cli-icon">
        ...
        <a className="cc-cli-card" href="/installation#pi">
          <div className="cc-cli-icon">
        ...
        <a className="cc-cli-card" href="/installation#gemini-cli">
          <div className="cc-cli-icon">
