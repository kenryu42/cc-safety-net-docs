...
description: "What CC Safety Net can't catch: transparent proxies, in-binary behavior, reads and network, symlink TOCTOU, interpreter flags, and eval-based execution."
---
