...
Related: [Safety modes](/configuration/modes) for selecting a level, [Commands blocked](/reference/blocked-commands) and [Commands allowed](/reference/allowed-commands) for the outcome reference, and [Known limitations](/guides/known-limitations) for what the classifier does not see.
