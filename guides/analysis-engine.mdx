...
description: "Inside the analysis engine: wrapper/interpreter recursion, git rules, rm -rf classification, find/xargs/parallel handling, and custom rule matching."
---
...
| 6 | **within-cwd target** | A path that resolves inside the current working directory | Allowed by default; blocked under [paranoid rm](/configuration/modes#rm-check-cc_safety_net_paranoid_rm=1) |
