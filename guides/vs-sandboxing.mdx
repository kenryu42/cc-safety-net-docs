...
| **Filesystem reads** | Broad by default | A bounded set of sensitive paths is blocked (`.env`, `~/.ssh/id_*`, `~/.aws`, coding-CLI credentials, plus your deny paths) |
