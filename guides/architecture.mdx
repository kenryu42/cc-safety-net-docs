...
description: "The entry points (CLI binary, OpenCode plugin, Pi extension), hook adapters, shared analysis engine, and the pipeline from command to allow or deny."
---
