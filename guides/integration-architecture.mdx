...
description: "How CC Safety Net plugs into Claude Code, Codex, Copilot CLI, Gemini CLI, Kimi Code, OpenCode, and Pi — hook subprocesses, plugins, and the in-process Pi extension."
---
