...
description: "Install CC Safety Net for any supported agent, verify it's working, and see a real blocked command. Works with Claude Code, Codex, Gemini CLI, GitHub Copilot CLI, Kimi Code, OpenCode, and Pi."
---
