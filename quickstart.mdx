...
<Steps>
  ...
  <Step title="Verify the installation">
    ...
    The doctor command checks every supported agent at once, so you don't need to tell it which one you use:

    - **Hook Integration** — the plugin/hook is configured for your agent
    - **Self-Test** — sample commands block and allow correctly (`git reset --hard` and `rm -rf /` blocked; `rm -rf ./node_modules` allowed)
